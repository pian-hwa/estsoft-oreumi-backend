...
<form action="${contextPath}/member/${action}" method="post" id="memberForm">
    ...
    <p>
        <label>
            <span>Email: </span><input type="email" name="email" value="${memberVo.email}" required>
        </label>
    </p>
    <p>
